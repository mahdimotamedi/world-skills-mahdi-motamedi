...
Shifts.Schedule.Model = {
    ...
    _saveShift: function(type, data, cb){
        ...
        Shifts.Ajax('./ajax/add', {
            type: 'post',
			url: 'http://127.0.0.1/practices/meli%20maharat%2015/12_Module_E/web/index.php?r=site%2Fsave-time-shift',
            data: data,
			dataType: 'json',
            success: function(res){
                if (res.status == 'failed') {
                    Shifts.ui.error('در هر روز امکان یک شیفت کاری برای گروه وجود دارد.');
                    cb.apply(this, arguments);
                    return false;
                }
				cb(data, cb, res);
